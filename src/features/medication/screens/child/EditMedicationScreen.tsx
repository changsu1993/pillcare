/**
 * EditMedicationScreen - Child's Edit Medication Screen
 *
 * Allows child users to edit their parent's medications.
  ...
  useEffect(() => {
    const loadMedication = async () => {
      try {
        ...
        setRefillThreshold(medication.refill_threshold ?? 7);
  ...
  if (isInitialLoading) {
    return (
      <View className="flex-1 bg-gray-50 justify-center items-center">
        ...
        <Text className="text-base text-gray-500 mt-3">약 정보를 불러오는 중...</Text>
      </View>
    );
  }
          ...
          >
            {isLoading ? (
              ...
              <View className="flex-row items-center gap-2">
                ...
                <Text className="text-base font-semibold text-white">수정 완료</Text>
              </View>
            )}
          </TouchableOpacity>
        </View>
